...
def openfoodfacts_produits():
    ...
    url = requests.get("https://fr.openfoodfacts.org/langue/francais/categorie/barres.json")
    data_raw = url.json()
...
def openfoodfacts_produit():
    ...
    url = requests.get("https://fr.openfoodfacts.org/api/v0/product/20110499.json")
    data_raw = url.json()
